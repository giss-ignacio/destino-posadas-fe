...
const EvolucionUbicacion = () => {
  ...
  const obtenerDatos = async () => {
    const data = await fetch(
      // "http://192.168.0.10:3009/api/fedata/evolucionMensualPorConcepto?concepto=Ubicacion"
      `http://${process.env.REACT_APP_IPLOCAL}:3009/api/fedata/evolucionMensualPorConcepto?concepto=Ubicacion`
    );
